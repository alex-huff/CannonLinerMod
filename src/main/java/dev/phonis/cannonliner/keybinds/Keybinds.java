...
public class Keybinds {
    ...
    public static final KeyBinding toggleSafePlace = new KeyBinding("Toggle Safe Place", Keyboard.KEY_LEFT, "Utils");
    ...
    public static void register() {
        ...
        ClientRegistry.registerKeyBinding(Keybinds.toggleSafePlace);
    }
